                ...
                <div className="subPageContent">
                    <div className="Rectangle53" style={{width: 1148.26, height: 763.83, top:300,  background: 'white', boxShadow: '0px 1.3224623203277588px 1.3224623203277588px rgba(0, 0, 0, 0.50)', borderRadius: 12.89}}>
                            ...
                            <div style={{display:'flex', justifyContent:'center'}}>
                                <div>
                                    <ButtonGroup className="mb-2">
                                        <Button onClick={()=>orderButtonOptionClick(1)} style={{width:240,borderRadius:'20px 0px 0px 20px',borderColor:'#79747E',color:'black',backgroundColor:orderOptionSelected.option1BC}}><img alt="" src={check} hidden={orderOptionSelected.option1ImgHidden}/>Categoria</Button>
                                        <Button onClick={()=>orderButtonOptionClick(2)} style={{width:240,borderColor:'#79747E',color:'black',backgroundColor:orderOptionSelected.option2BC}}><img alt="" src={check} hidden={orderOptionSelected.option2ImgHidden}/>Últimos Lançamentos</Button>
                                        <Button onClick={()=>orderButtonOptionClick(3)} style={{width:240,borderRadius:'0px 20px 20px 0px',borderColor:'#79747E',color:'black',backgroundColor:orderOptionSelected.option3BC}}><img alt="" src={check} hidden={orderOptionSelected.option3ImgHidden}/>{orderOptionSelected.option3Text}</Button>
                                    </ButtonGroup>
                                </div>
                            </div>                                    
                        </div>
                        <div style={{width: 1120, height: 420.38, left: 10, top: 220, position: 'relative', background: 'white', boxShadow: '10px 10px 10px rgba(0, 0, 0, 0.04)', borderRadius: 19}}>
                            <FinancialEntry sortOption={orderOptionSelected.optionSelected} interactionId={interationId} onRowSelection={onSelectGridRow}/>
                        </div>                      
                    </div>
                </div>
            </div>
