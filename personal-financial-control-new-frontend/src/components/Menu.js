...
export default function Menu(){
    ...
    const handleClick = (routeName,entryType) => {
        if (!isUndefined(entryType)) {
            const query = new URLSearchParams()
            query.set("type",entryType)
            navigate(routeName+'?'+query.toString())
        } else {
            navigate(routeName)
        }
    }
    ...
    return(
        <div>
            ...
            <div data-layer="Group 85" className="menuButton" onClick={()=>{handleClick('/')}} style={{width: 200, height: 48, left: 43, top: 256, position: 'absolute'}}>
            ...
            <div data-layer="Group 80" className="menuButton" onClick={()=>{handleClick('/financial-entry','reserve')}} style={{width: 200, height: 56, left: 40, top: 572, position: 'absolute'}}>
                <div data-svg-wrapper data-layer="Dollar sign" data-size="48" className="DollarSign" style={{left: 0, top: 4, position: 'absolute'}}>
                    <img alt="" src={ReserveIcon}/>
                </div>
            ...
            <div data-layer="Group 78" className="menuButton" onClick={()=>{handleClick('/financial-control')}} style={{width: 200, height: 72, left: 40, top: 645, position: 'absolute'}}>
                <div data-layer="controle mensal" className="ControleMensal" style={{left: 70, top: 0, position: 'absolute', color: 'black', fontSize: 24, fontFamily: 'Poppins', fontWeight: '700', wordWrap: 'break-word'}}>controle <br/>mensal</div>
                    <div data-svg-wrapper data-layer="Trending up" data-size="48" className="TrendingUp" style={{left: 0, top: 4, position: 'absolute'}}>
                        <img alt="" src={ControlIcon}/>
                    </div>
            </div>            
            <div data-layer="Group 84" className="menuButton" onClick={()=>{handleClick('/financial-entry','revenue')}} style={{width: 200, height: 68, left: 35, top: 319, position: 'absolute'}}>
            ...
            <div data-layer="Group 83" className="menuButton" onClick={()=>{handleClick('/financial-entry','expense')}} style={{width: 200, height: 68, left: 35, top: 402, position: 'absolute'}}>
            ...
            <div data-layer="Group 82" className="menuButton" onClick={()=>{handleClick('/credit-card')}} style={{width: 200, height: 72, left: 36, top: 485, position: 'absolute'}}>
